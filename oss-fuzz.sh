...
(
# fuzz quic-go
compile_go_fuzzer github.com/TugasAkhir-QUIC/quic-go/fuzzing/frames Fuzz frame_fuzzer
compile_go_fuzzer github.com/TugasAkhir-QUIC/quic-go/fuzzing/header Fuzz header_fuzzer
compile_go_fuzzer github.com/TugasAkhir-QUIC/quic-go/fuzzing/transportparameters Fuzz transportparameter_fuzzer
compile_go_fuzzer github.com/TugasAkhir-QUIC/quic-go/fuzzing/tokens Fuzz token_fuzzer
compile_go_fuzzer github.com/TugasAkhir-QUIC/quic-go/fuzzing/handshake Fuzz handshake_fuzzer
...
cd $GOPATH/src/github.com/TugasAkhir-QUIC/quic-go/

...
//
//	mockgen.exe -typed -package quic -self_package github.com/TugasAkhir-QUIC/quic-go -self_package github.com/TugasAkhir-QUIC/quic-go -destination mock_packetconn_test.go net PacketConn
//

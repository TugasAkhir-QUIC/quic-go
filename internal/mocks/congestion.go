...
// Source: github.com/TugasAkhir-QUIC/quic-go/internal/congestion (interfaces: SendAlgorithmWithDebugInfos)
//
// Generated by this command:
//
//	mockgen.exe -typed -build_flags=-tags=gomock -package mocks -destination congestion.go github.com/TugasAkhir-QUIC/quic-go/internal/congestion SendAlgorithmWithDebugInfos
//
...
func (mr *MockSendAlgorithmWithDebugInfosMockRecorder) BandwidthEstimate() *SendAlgorithmWithDebugInfosBandwidthEstimateCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "BandwidthEstimate", reflect.TypeOf((*MockSendAlgorithmWithDebugInfos)(nil).BandwidthEstimate))
	return &SendAlgorithmWithDebugInfosBandwidthEstimateCall{Call: call}
}

// SendAlgorithmWithDebugInfosBandwidthEstimateCall wrap *gomock.Call
type SendAlgorithmWithDebugInfosBandwidthEstimateCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *SendAlgorithmWithDebugInfosBandwidthEstimateCall) Return(arg0 congestion.Bandwidth) *SendAlgorithmWithDebugInfosBandwidthEstimateCall {
	c.Call = c.Call.Return(arg0)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *SendAlgorithmWithDebugInfosBandwidthEstimateCall) Do(f func() congestion.Bandwidth) *SendAlgorithmWithDebugInfosBandwidthEstimateCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *SendAlgorithmWithDebugInfosBandwidthEstimateCall) DoAndReturn(f func() congestion.Bandwidth) *SendAlgorithmWithDebugInfosBandwidthEstimateCall {

...
// Source: github.com/TugasAkhir-QUIC/quic-go (interfaces: QUICConn)
//
// Generated by this command:
//
//	mockgen.exe -typed -build_flags=-tags=gomock -package quic -self_package github.com/TugasAkhir-QUIC/quic-go -destination mock_quic_conn_test.go github.com/TugasAkhir-QUIC/quic-go QUICConn
//
...
import (
	...
	qerr "github.com/TugasAkhir-QUIC/quic-go/internal/qerr"
...
func (mr *MockQUICConnMockRecorder) GetMaxBandwidth() *QUICConnGetMaxBandwidthCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetMaxBandwidth", reflect.TypeOf((*MockQUICConn)(nil).GetMaxBandwidth))
	return &QUICConnGetMaxBandwidthCall{Call: call}
}

// QUICConnGetMaxBandwidthCall wrap *gomock.Call
type QUICConnGetMaxBandwidthCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *QUICConnGetMaxBandwidthCall) Return(arg0 uint64) *QUICConnGetMaxBandwidthCall {
	c.Call = c.Call.Return(arg0)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *QUICConnGetMaxBandwidthCall) Do(f func() uint64) *QUICConnGetMaxBandwidthCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *QUICConnGetMaxBandwidthCall) DoAndReturn(f func() uint64) *QUICConnGetMaxBandwidthCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
...
func (m *MockQUICConn) SetMaxBandwidth(arg0 uint64) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "SetMaxBandwidth", arg0)
}

// SetMaxBandwidth indicates an expected call of SetMaxBandwidth.
func (mr *MockQUICConnMockRecorder) SetMaxBandwidth(arg0 any) *QUICConnSetMaxBandwidthCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetMaxBandwidth", reflect.TypeOf((*MockQUICConn)(nil).SetMaxBandwidth), arg0)
	return &QUICConnSetMaxBandwidthCall{Call: call}
}

// QUICConnSetMaxBandwidthCall wrap *gomock.Call
type QUICConnSetMaxBandwidthCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *QUICConnSetMaxBandwidthCall) Return() *QUICConnSetMaxBandwidthCall {
	c.Call = c.Call.Return()
	return c
}

// Do rewrite *gomock.Call.Do
func (c *QUICConnSetMaxBandwidthCall) Do(f func(uint64)) *QUICConnSetMaxBandwidthCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *QUICConnSetMaxBandwidthCall) DoAndReturn(f func(uint64)) *QUICConnSetMaxBandwidthCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
